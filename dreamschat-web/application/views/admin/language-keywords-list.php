                        ...
                        <div class='table-top'>
                            <div class='wordset'>
                                <div class="d-flex">
                                    ...
                                    <button type="button" class="btn btn-primary" id="change-language" onclick="changeLanguage();">Search</button> 
                                    <!--  -->
                                </div>
                            </div>
                            <ul>
                                <li>
                                    <div class="pass-login">
                                        <input type="text" id="search-language-keywords" class="form-control" placeholder="Search">
                                    </div>  
                                </li>
                            </ul>
                        </div>
                        <div class='table-responsive'>
                            <table class='table datanews table-hover table-center mb-0' id='language-keywords-list'>
                                <thead>
                                <tr>
								<th>Language</th>
                                <th>Page</th>
