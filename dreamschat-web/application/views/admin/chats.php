    ...
    <div class="content container-fluid">
		<div class="page-header">
			<div class="page-title">
				<h4>Chat <span class="count-details" id="chats_total_count">0</span></h4>
			</div>
		</div>
		<div class="row">
					...
					<div class="card-body">
                        <div class='table-top'>
                            ...
                            <ul>
                                <li>
                                    <div class="col-auto">
		                                <input type="text" id="search-chatlistadmin-content" class="user-filter" placeholder="Search">
		                            </div> 
                                </li>
                            </ul>
                        </div>
						<div class="table-responsive">
							<table class="table datanews table-hover table-center mb-0" id="chats-list-table">
								<thead>
									<tr>
										<th>S.No</th>
										<th>From</th>
