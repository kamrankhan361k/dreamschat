        ...
        <div class="content container-fluid">
			<div class="page-header">
				<div class="page-title">
					<h4>Block Users <span class="count-details"id="userspageblocked_total_count">0</span></h4>
				</div>
			</div>
			<div class="row">
					...
					<div class="card card-table flex-fill">
                        ...
                        <div class='table-top'>
                            ...
                            <ul>
                                <li>
                                    <div class="col-auto">
		                                <input type="text" id="search-blocklist-content" class="user-filter" placeholder="Search">
		                            </div>  
                                </li>
                            </ul>
                        </div>
						<div class="table-responsive">
							<table class="table datanews table-hover table-center mb-0" id="blockList-list-table">
								<thead>
									<tr>
										<th>S.No</th>
										<th>Name</th>
								...
								<tbody class="blockuser-list-table">
