...
?>
<!-- sidebar group -->
<div class="sidebar-group left-sidebar chat_sidebar" id="group-sidebar">
        ...
        <div class="slimscroll">
           ...
           <!-- /Left Chat Title -->
            ...
            <div class="sidebar-body chat-body" id="chatsidebar">
                ...
                <div class="d-flex justify-content-between align-items-center ps-0 pe-0">
                    <div class="fav-title pin-chat">
                        <h6><?php echo ($ul['sidebar-group']['recent_chat'])?$ul['sidebar-group']['recent_chat']: "Recent Chat"; ?> </span></div></h6>
                    </div>
                </div>
                <!-- /Left Chat Title -->
